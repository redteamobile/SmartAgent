...
public class AssetUtil {
    ...
    public void copyFileInThread(
        ...
        LogUtil.i(TAG, "copyFileOnThread() ");
            ...
            public void run() {
                try {
                    ...
                    if (!verifyPlmnMd5(assetFileName, fileName, dir)) {
                        LogUtil.i(TAG, "Md5 misMatch");
                        copyFileInThread(assetFileName, fileName, dir);
                    } else {
                        LogUtil.i(TAG, "Md5 is match! ");
    ...
    public void copyFile(String assetFileName, String fileName, String dir) throws IOException {
        LogUtil.i(TAG, String.format("copyFile(fileName: %s) start", fileName));
        ...
        LogUtil.i(TAG, String.format("copyFile(fileName: %s) end", fileName));
    }
